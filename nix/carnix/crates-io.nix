...
# varlink_derive-8.0.0
  ...
  crates.varlink_derive."8.0.0" = deps: { features?(features_.varlink_derive."8.0.0" deps {}) }: buildRustCrate {
    crateName = "varlink_derive";
    version = "8.0.0";
    description = "Rust code generator macro for the varlink protocol.";
    authors = [ "Harald Hoyer <harald@redhat.com>" ];
    edition = "2018";
    sha256 = "1y16chbjwylgpw4hpwi2r6z1dfwkz9vq6hj85drsfb3vx0clvbg3";
    libPath = "src/lib.rs";
    dependencies = mapFeatures features ([
      (crates."varlink_generator"."${deps."varlink_derive"."8.0.0"."varlink_generator"}" deps)
    ]);
  };
  features_.varlink_derive."8.0.0" = deps: f: updateFeatures f (rec {
    varlink_derive."8.0.0".default = (f.varlink_derive."8.0.0".default or true);
    varlink_generator."${deps.varlink_derive."8.0.0".varlink_generator}".default = true;
  }) [
    (features_.varlink_generator."${deps."varlink_derive"."8.0.0"."varlink_generator"}" deps)
  ];


# end
# varlink_generator-8.0.0

  crates.varlink_generator."8.0.0" = deps: { features?(features_.varlink_generator."8.0.0" deps {}) }: buildRustCrate {
    crateName = "varlink_generator";
    version = "8.0.0";
    description = "Rust code generator for the varlink protocol.";
    authors = [ "Harald Hoyer <harald@redhat.com>" ];
    edition = "2018";
    sha256 = "1vzg9l6bk2lqgqkxinrbs6jig9amdn0rlxv6ww39pjpdvdlrjd2a";
    libPath = "src/lib.rs";
    crateBin =
      [{  name = "varlink-rust-generator";  path = "src/bin/varlink-rust-generator.rs"; }];
    dependencies = mapFeatures features ([
      (crates."chainerror"."${deps."varlink_generator"."8.0.0"."chainerror"}" deps)
      (crates."getopts"."${deps."varlink_generator"."8.0.0"."getopts"}" deps)
      (crates."proc_macro2"."${deps."varlink_generator"."8.0.0"."proc_macro2"}" deps)
      (crates."quote"."${deps."varlink_generator"."8.0.0"."quote"}" deps)
      (crates."syn"."${deps."varlink_generator"."8.0.0"."syn"}" deps)
      (crates."varlink_parser"."${deps."varlink_generator"."8.0.0"."varlink_parser"}" deps)
    ]);
  };
  features_.varlink_generator."8.0.0" = deps: f: updateFeatures f (rec {
    chainerror."${deps.varlink_generator."8.0.0".chainerror}".default = true;
    getopts."${deps.varlink_generator."8.0.0".getopts}".default = true;
    proc_macro2."${deps.varlink_generator."8.0.0".proc_macro2}".default = true;
    quote."${deps.varlink_generator."8.0.0".quote}".default = true;
    syn."${deps.varlink_generator."8.0.0".syn}".default = true;
    varlink_generator."8.0.0".default = (f.varlink_generator."8.0.0".default or true);
    varlink_parser."${deps.varlink_generator."8.0.0".varlink_parser}".default = true;
  }) [
    (features_.chainerror."${deps."varlink_generator"."8.0.0"."chainerror"}" deps)
    (features_.getopts."${deps."varlink_generator"."8.0.0"."getopts"}" deps)
    (features_.proc_macro2."${deps."varlink_generator"."8.0.0"."proc_macro2"}" deps)
    (features_.quote."${deps."varlink_generator"."8.0.0"."quote"}" deps)
    (features_.syn."${deps."varlink_generator"."8.0.0"."syn"}" deps)
    (features_.varlink_parser."${deps."varlink_generator"."8.0.0"."varlink_parser"}" deps)
  ];
