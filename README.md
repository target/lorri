...
### Should I check the `.envrc` into git/my source control?
...
environments, you can still check in your `.envrc`, by checking for
`lorri` and providing a fallback to `direnv`’s builtin `use nix` support:
